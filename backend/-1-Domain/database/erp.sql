...
DROP TABLE IF EXISTS "erp"."tb_default_cost_center_distribution";
/*------------------------------------------------------------*/
/*                     Criação das tabelas                    */
/*------------------------------------------------------------*/
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE "erp"."tb_contract"(
	...
	"contract_value"                       bigint               DEFAULT 0 NOT NULL,
	...
	"contract_has_thirteenth_salary"       boolean              DEFAULT true NOT NULL,
	"contract_has_vacation_bonus"          boolean              DEFAULT true NOT NULL,
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE "erp"."tb_contract_benefit_discount"(
	...
	"contract_benefit_discount_amount"     bigint               DEFAULT 0 NOT NULL,
	"contract_benefit_discount_month"      integer              NULL,
	"contract_benefit_discount_has_taxes"  boolean              DEFAULT false NOT NULL,
	"contract_benefit_discount_is_proportional" boolean          DEFAULT true NOT NULL,
	"criado_por"                           bigint               DEFAULT 0 NOT NULL,
	"atualizado_por"                       bigint               NULL,
	"criado_em"                            timestamptz          DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"atualizado_em"                        timestamptz          NULL,
...
/*------------------------------------------------------------*/
/*    Criação de Tabelas, Indices e Atribuição de Default    */
/*    erp.tb_default_cost_center_distribution    */
/*------------------------------------------------------------*/

 CREATE TABLE "erp"."tb_default_cost_center_distribution"(
	...
	"criado_em"                            timestamptz          DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"atualizado_em"                        timestamptz          NULL,
		CONSTRAINT "pk_default_cost_center_distribution" PRIMARY KEY 
		(
			"default_cost_center_distribution_id"
		) 
);

ALTER TABLE "erp"."tb_default_cost_center_distribution" ADD CONSTRAINT "uk_default_cc_dist_company_cost_center" UNIQUE("company_id","cost_center_id");
/*------------------------------------------------------------*/
/*    Criação de Tabelas, Indices e Atribuição de Default    */
/*       erp.tb_employee       */
/*------------------------------------------------------------*/
...
-- Constraints UNIQUE com suporte a NULL (permite múltiplos NULL, mas valores não-NULL devem ser únicos)
CREATE UNIQUE INDEX "uk_employee_cpf" ON "erp"."tb_employee"("employee_cpf") WHERE "employee_cpf" IS NOT NULL;
CREATE UNIQUE INDEX "uk_employee_email" ON "erp"."tb_employee"("employee_email") WHERE "employee_email" IS NOT NULL;
ALTER TABLE "erp"."tb_employee" ADD CONSTRAINT "uk_employee_nickname" UNIQUE("company_id","employee_nickname");
CREATE UNIQUE INDEX "uk_employee_phone" ON "erp"."tb_employee"("employee_phone") WHERE "employee_phone" IS NOT NULL;
/*------------------------------------------------------------*/
/*    Criação de Tabelas, Indices e Atribuição de Default    */
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE "erp"."tb_loan_advance"(
	...
	"loan_advance_date"                    date                 DEFAULT CURRENT_DATE NOT NULL,
	"criado_por"                           bigint               DEFAULT 0 NOT NULL,
	"atualizado_por"                       bigint               NULL,
	"criado_em"                            timestamptz          DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"atualizado_em"                        timestamptz          NULL,
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE "erp"."tb_payroll_employee"(
	...
	"payroll_employee_base_salary"         decimal (10,2)       DEFAULT 0 NOT NULL,
	...
	"payroll_employee_vacation_advance_paid" boolean              DEFAULT false NOT NULL,
	"payroll_employee_vacation_start_date" date                 NULL,
	"payroll_employee_vacation_end_date"   date                 NULL,
	"payroll_employee_vacation_notes"      text                 NULL,
	"payroll_employee_vacation_advance_inss" bigint             DEFAULT 0,
	"payroll_employee_vacation_advance_irrf" bigint             DEFAULT 0,
	"payroll_employee_vacation_advance_benefits" boolean        DEFAULT false,
	"payroll_employee_has_13th"            boolean              DEFAULT false NOT NULL,
	"payroll_employee_13th_type"           varchar (10)         NULL,
	"payroll_employee_13th_amount"         decimal (10,2)       NULL,
	"payroll_employee_13th_tax_option"     varchar (10)         NULL,
	"payroll_employee_notes"               text                 NULL,
	"payroll_employee_worked_units"        decimal (10,2)       NULL,
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE "erp"."tb_payroll_item"(
	...
	"payroll_item_type"                    varchar (20)         NOT NULL,
	"payroll_item_category"                varchar (50)         NOT NULL,
	...
	"payroll_item_is_manual"               boolean              DEFAULT false NOT NULL,
	"payroll_item_is_active"               boolean              DEFAULT true NOT NULL,
	"payroll_item_source_type"             varchar (30)         NULL,
	"payroll_item_installment_number"      int                  NULL,
	"payroll_item_installment_total"       int                  NULL,
	"criado_por"                           bigint               DEFAULT 0 NOT NULL,
	"atualizado_por"                       bigint               NULL,
	"criado_em"                            timestamptz          DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"atualizado_em"                        timestamptz          NULL,
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE "erp"."tb_purchase_order"(
	...
	"purchase_order_processed_message"     text                 NULL,
	"purchase_order_processed_at"          timestamptz          NULL,
	"criado_por"                           bigint               DEFAULT 0 NOT NULL,
	"atualizado_por"                       bigint               NULL,
	"criado_em"                            timestamptz          DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"atualizado_em"                        timestamptz          NULL,
...
/*------------------------------------------------------------*/
/*    Criação de Tabelas, Indices e Atribuição de Default    */
/*    erp.tb_account_payable_receivable_cost_center    */
/*------------------------------------------------------------*/

 CREATE TABLE "erp"."tb_account_payable_receivable_cost_center"(
	"account_payable_receivable_cost_center_id"  bigint               NOT NULL GENERATED BY DEFAULT AS IDENTITY ,
	"account_payable_receivable_id"              bigint               DEFAULT 0 NOT NULL,
	"cost_center_id"                             bigint               DEFAULT 0 NOT NULL,
	"account_payable_receivable_cost_center_amount"      decimal (15,2)       DEFAULT 0 NOT NULL,
	"account_payable_receivable_cost_center_percentage"  decimal (5,2)        DEFAULT 0 NOT NULL,
	"criado_por"                                 bigint               DEFAULT 0 NOT NULL,
	"atualizado_por"                             bigint               NULL,
	"criado_em"                                  timestamptz          DEFAULT CURRENT_TIMESTAMP NOT NULL,
	"atualizado_em"                              timestamptz          NULL,
		CONSTRAINT "pk_account_payable_receivable_cost_center" PRIMARY KEY 
		(
			"account_payable_receivable_cost_center_id"
		),
		CONSTRAINT "chk_apr_cost_center_percentage" CHECK (account_payable_receivable_cost_center_percentage >= 0 AND account_payable_receivable_cost_center_percentage <= 100)
);

ALTER TABLE "erp"."tb_account_payable_receivable_cost_center" ADD CONSTRAINT "uk_apr_cost_center" UNIQUE("account_payable_receivable_id","cost_center_id");
...
ALTER TABLE "erp"."tb_default_cost_center_distribution" ADD CONSTRAINT "fk_default_cc_dist_company"
	FOREIGN KEY
		("company_id")
	REFERENCES "erp"."tb_company"
		("company_id")
...
ALTER TABLE "erp"."tb_default_cost_center_distribution" ADD CONSTRAINT "fk_default_cc_dist_cost_center"
	FOREIGN KEY
		("cost_center_id")
	REFERENCES "erp"."tb_cost_center"
		("cost_center_id")
...
ALTER TABLE "erp"."tb_purchase_order" ADD CONSTRAINT "fk_purchase_order_account"
	FOREIGN KEY
		("account_id")
	REFERENCES "erp"."tb_account"
		("account_id");
...
ALTER TABLE "erp"."tb_account_payable_receivable_cost_center" ADD CONSTRAINT "fk_apr_cost_center_apr"
	FOREIGN KEY
		("account_payable_receivable_id")
	REFERENCES "erp"."tb_account_payable_receivable"
		("account_payable_receivable_id")
...
ALTER TABLE "erp"."tb_account_payable_receivable_cost_center" ADD CONSTRAINT "fk_apr_cost_center_cost_center"
	FOREIGN KEY
		("cost_center_id")
	REFERENCES "erp"."tb_cost_center"
		("cost_center_id");
...
/*------------------------------------------------------------*/
/*   Foreign Keys e Índices - Melhorias de Payroll   */
/*------------------------------------------------------------*/

-- Foreign Keys
ALTER TABLE "erp"."tb_payroll" ADD CONSTRAINT "fk_payroll_closed_by"
	FOREIGN KEY
		("payroll_closed_by")
	REFERENCES "erp"."tb_user"
		("user_id");
...
-- Índices de Performance - tb_payroll
...
-- Índices de Performance - tb_payroll_employee
...
-- Índices de Performance - tb_payroll_item
...
-- Índices de Performance - tb_loan_advance
...
-- Índices de Performance - tb_contract
